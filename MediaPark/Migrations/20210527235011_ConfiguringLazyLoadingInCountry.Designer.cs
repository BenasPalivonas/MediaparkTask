...
namespace MediaPark.Migrations
{
    ...
    [Migration("20210527235011_ConfiguringLazyLoadingInCountry")]
    partial class ConfiguringLazyLoadingInCountry
    {
            ...
            modelBuilder.Entity("MediaPark.Entities.HolidayName", b =>
                {
                    b.HasOne("MediaPark.Entities.Holiday", "Holiday")
                        .WithOne("HolidayName")
                        .HasForeignKey("MediaPark.Entities.HolidayName", "HolidayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
