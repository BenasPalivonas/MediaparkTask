...
namespace MediaPark.Migrations
{
    ...
    [Migration("20210527201917_AddingManyToManyForCountryAndHolidayType")]
    partial class AddingManyToManyForCountryAndHolidayType
    {
            ...
            modelBuilder.Entity("MediaPark.Entities.Holiday", b =>
                {
                    ...
                    b.HasOne("MediaPark.Entities.HolidayDate", "HolidayDate")
                        .WithMany()
                        .HasForeignKey("HolidayDateId");

                    b.HasOne("MediaPark.Entities.HolidayName", "HolidayName")
                        .WithMany()
